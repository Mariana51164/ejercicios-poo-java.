public class Pedido {
    ...
    public Pedido() { this("", 1, 0.0, 0.0, false); }
    ...
    public Pedido(String id, int unidades, double precioUnitario, double costoEnvio, boolean pagado) {
        ...
        this.costoEnvio = Math.max(0, costoEnvio);
        this.pagado = pagado;
    }

    public double total() { return Math.round((unidades * precioUnitario + costoEnvio) * 100.0) / 100.0; }
    ...
    public String toString() {
        return "Pedido " + id + " | Total: $" + total() + " | Pagado: " + pagado;
    }
}
