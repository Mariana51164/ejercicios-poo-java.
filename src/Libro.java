public class Libro {
    ...
    public Libro(String titulo, String autor, int ejemplaresTotales, int ejemplaresPrestados) {
        ...
        this.ejemplaresPrestados = Math.max(0, ejemplaresPrestados);
        if (this.ejemplaresPrestados > this.ejemplaresTotales) {
            this.ejemplaresPrestados = this.ejemplaresTotales;
        }
    }

    public boolean prestar() {
        if (ejemplaresTotales - ejemplaresPrestados > 0) {
            ejemplaresPrestados++;
            return true;
        }
        return false;
    ...
    public void setEjemplaresTotales(int ejemplaresTotales) {
        if (ejemplaresTotales >= 0 && ejemplaresTotales >= ejemplaresPrestados) {
